...
Процедура ПересчитатьСебестоимостьПоТехкарточкеНаСервере()
    ...
    Объект.СебестоимостьПорции = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(
        Объект.Техкарточка, "СебестоимостьПорции");
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
    ...
    // Синхронизируем себестоимость с техкарточкой, если она выбрана
    Если ЗначениеЗаполнено(ТекущийОбъект.Техкарточка) Тогда

        ТекущийОбъект.СебестоимостьПорции = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(
            ТекущийОбъект.Техкарточка, "СебестоимостьПорции");
